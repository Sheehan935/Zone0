...
- [x] **Perimeter Photo Review**: Replaced with a custom Cloudflare Worker form (photos + notes), 2026-08-20 — see `worker/README.md`. Pending: one-time Cloudflare/Resend account setup before the live form is functional.
