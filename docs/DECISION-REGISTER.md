...
### 2026-08-19 — LOCKED: One-page homepage architecture

**Decision:** The Zone 0 public site is a ONE-PAGE HOMEPAGE (`index.html`)
plus `pages/thank-you.html`. Sections, in order: Header, Hero, Lean/Green/
Clean, Landscaping/Hardscaping/Design, Visual Proof, Understand the Zones,
Resources, How We Help, Free Photo Check, Footer. Brand hierarchy: primary
positioning "Protecting Homes. Preserving Landscapes.," philosophy "Lean.
Green. Clean.," practical promise "Know what to fix. Get the work done.
Keep the proof."

This supersedes the 2026-08-03–08-18 multi-page implementation recorded
above (2026-08-05 entry) — that implementation was real and deliberate at
the time, not an error; it is superseded, not erased from this record.
`/zone-0/`, `/materials/`, `/faq/`, `/design/`, and `pages/services.html`
are retained on disk as source material for homepage consolidation and are
explicitly NOT deleted as part of this decision.
