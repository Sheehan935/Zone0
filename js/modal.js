(function() {
    function initModal() {
        ...
        const modalHTML = `
        <div id="photo-modal" class="fixed inset-0 bg-stone-900/80 backdrop-blur-sm z-[9999] hidden flex items-center justify-center p-4">
            <div class="bg-white border border-stone-200 max-w-lg w-full p-8 shadow-2xl relative text-left">
                <button id="close-modal-btn" type="button" class="absolute top-4 right-4 text-stone-400 hover:text-stone-900 text-xl font-bold p-2">
        ...
        document.addEventListener('click', (e) => {
            ...
            if (btn && (btn.innerText.toLowerCase().includes('free photo check') || btn.getAttribute('href') === '#photo-check')) {
                e.preventDefault();
